function tobookingpage(){
    ...
    if(document.getElementById("passengername").value != "" && document.getElementById("passengerphone").value != "" && document.getElementById("passengerpickup").value != "" &&document.getElementById("passengerphone").value.length >= 10 && document.getElementById("pickupdate").value != "" && document.getElementById("pickuptime").value != "" ){
...
function infoextractor(){
    ...
    if(passname != "" && passphone != "" && passpick != "" && passdrop != "" && passtrip != "" && passdate != "" && passtime != ""){
        localStorage.setItem("passname",passname);
        localStorage.setItem("passphone",passphone);
        localStorage.setItem("passpick",passpick);
        localStorage.setItem("passdrop",passdrop);
...
document.getElementById("pickinfobp").innerText = localStorage.getItem("passpick");
document.getElementById("dropinfobp").innerText = localStorage.getItem("passdrop");
document.getElementById("pickdatebp").innerText = localStorage.getItem("passdate");
document.getElementById("picktimebp").innerText = localStorage.getItem("passtime");
/*Updation in the booking page ends*/


/*Car confirm page updation*/ 

var pickfinal = document.getElementById("pickinfobp").innerText = localStorage.getItem("passpick");
var dropfinal = document.getElementById("dropinfobp").innerText = localStorage.getItem("passdrop");
var datefinal = document.getElementById("pickdatebp").innerText = localStorage.getItem("passdate");
var timefinal = document.getElementById("picktimebp").innerText = localStorage.getItem("passtime")
var farefinal = document.getElementById("farespancnf").innerText = localStorage.getItem("carfare");
var cardetailsfinal = document.getElementById("cardetailscnf").innerText = localStorage.getItem("cardetails");
var carmodelfinal = document.getElementById("modeldetailscnf").innerText = localStorage.getItem("carmodel");
var extratextfinal = document.getElementById("extratextcnf").innerText = localStorage.getItem("extracontent");
...
function indexpageinfoextractor(){
    ...
    localStorage.setItem("passphonetele",phone);localStorage.setItem("passpickuptele",pickuptele);
...
//bot token
var telegram_bot_id = "6350062138:AAFt7yPdXvMWIGvgaihjA4fIlO5I9O2h_d8";
//chat id
...
var ready = function () {
    ...
    message ="i5 Call Taxi - Best Taxi Services in Vellore" +"\nPassenger Name :- "+passname +"\nPassenger Phone :-" + passphone + "\nPickup Location :-" + passpick + "\nDrop Location :-"+passdrop + "\nType of trip :-"+passway + "\nPickup Date :- "+passdate + "\nPickup Time :-"+passtime+"\nCab Type :-" + passvehicle + "\nVehicle Model" + passvehiclemodel + "\nFare :-"+passvehiclefare;
};
var sender = function () {
    ready();
    var settings = {
